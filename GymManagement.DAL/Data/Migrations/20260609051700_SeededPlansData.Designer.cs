...
namespace GymManagement.DAL.Data.Migrations
{
    ...
    [Migration("20260609051700_SeededPlansData")]
    partial class SeededPlansData
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("Members", t =>
                        {
                            ...
                            t.HasCheckConstraint("PhoneCheck", "Phone Like '01[0125]%'");
                        });
                });

            modelBuilder.Entity("GymManagement.DAL.Data.Models.MemberPlans", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MemberPlans", t =>
                        {
                            t.HasCheckConstraint("CheckEndDateValid", "EndDate > StartDate");
                        });
                });

            modelBuilder.Entity("GymManagement.DAL.Data.Models.MemberSessions", b =>
                {
                    b.Property<int>("MemberId")
                        .HasColumnType("int");
